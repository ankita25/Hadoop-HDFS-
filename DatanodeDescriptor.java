...
public class DatanodeDescriptor extends DatanodeInfo {
    ...
    void reportDiff(BlocksMap blocksMap,
        ...
        //System.out.println(" In Report Diff");
        ...
        //    System.out.println("REPORTING DIFF CONNECTIONS ARE"+newReport.getActiveConn(i));           
            iblk.set(newReport.getBlockId(i), newReport.getBlockLen(i), 
                     newReport.getBlockGenStamp(i), newReport.getActiveConn(i));//PROJECT
	 //System.out.println("The iblk connections are"+iblk.getActiveConnection());           
	 BlockInfo storedBlock = blocksMap.getStoredBlock(iblk);
            if(storedBlock == null) {
                ...
                oblk.set(newReport.getBlockId(i), newReport.getBlockLen(i),
                         GenerationStamp.WILDCARD_STAMP,newReport.getActiveConn(i));//PROJECT
                ...
                if (storedBlock != null && storedBlock.getINode() != null &&
                    ...
                    //PROJECT
                    //System.out.println("Setting value"+(int)newReport.getActiveConn(i));                
                    storedBlock.setActiveConnection((int)newReport.getActiveConn(i));
