...
//PROJECT
  ...
  private static int index2ActiveConn(int index){
 ...
 //PROJECT
  public long getActiveConn(final int index){
    
//System.out.println("BlockList as longs"+blockList[index2ActiveConn(index)]);
return blockList[index2ActiveConn(index)];
  ...
  void setBlock(final int index, final Block b) {
   ...
   blockList[index2ActiveConn(index)] = b.getActiveConnection();
System.out.println("In set block in block list as longs the connections are"+b.getActiveConnection()); 
 }
}
