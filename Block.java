...
public class Block implements Writable, Comparable<Block> {
  ...
  private long activeConnection;//PROJECT
  ...
  setActiveConnection((int)blk.activeConnection);
  ...
  public void set(long blkid, long len, long genStamp,long activeconnection){
    this.blockId = blkid;
    this.numBytes = len;
    this.generationStamp = genStamp;
    this.activeConnection = activeconnection;//Project
  } 
...
//PROJECT
  ...
  this.activeConnection = this.activeConnection + 1;
}
  public void decrementActiveConnection(){
 this.activeConnection = this.activeConnection -1 ;
  
}  
  public long getActiveConnection(){
  return activeConnection;
}

public void setActiveConnection(int count){
this.activeConnection = count;
